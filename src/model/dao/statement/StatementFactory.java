...
public class StatementFactory {
  ...
  protected PreparedStatement createInsertStatement(Tabela tabela, HashMap<? extends Info, Object> dados) {
  ...
  protected PreparedStatement createSelectStatement(Tabela tabela, Info[] conditions, Object[] conditionsValues, Info... infos) {
    ...
    for (int i = 0; i < conditions.length; i++)
      sb.addCondition(conditions[i]).addConditionValue(conditionsValues[i]);
